...
SECTIONS = {
  ...
  "§12 — Lexical Grammar": [
    ...
    ("Tagged template literals",        "§12.9.5",  MISSING, "TaggedTemplateExpression → T_ANY stub"),
  ...
  "§13 — Expressions": [
    ...
    ("Object initializer {}",           "§13.2.5",  PARTIAL, "ObjectExpression; ObjectMethod not typed"),
    ("Object shorthand methods",        "§13.2.5",  MISSING, "ObjectMethod → T_ANY in object type"),
    ("Object computed property keys",   "§13.2.5",  MISSING, "Computed keys ignored in ObjectType"),
    ("Object getter/setter literals",   "§13.2.5",  MISSING, "ObjectMethod get/set → T_ANY"),
    ("Spread in array literal [...x]",  "§13.2.4",  MISSING, "SpreadElement in array literal ignored"),
    ("Spread in object literal {...o}", "§13.2.5",  MISSING, "SpreadElement in object literal ignored"),
    # Member access
    ...
    ("Optional call fn?.()",            "§13.5.1",  DONE,    "OptionalCallExpression"),
    ...
    ("super(args) in constructor",      "§13.3.7",  MISSING, "Super node → T_ANY"),
    ("super.method()",                  "§13.3.7",  MISSING, "Super property → T_ANY"),
    ...
    ("delete operator",                 "§13.5.1",  MISSING, "UnaryExpression delete → T_ANY (should be boolean)"),
    ...
    ("in operator",                     "§13.10",   MISSING, "BinaryExpression 'in' → T_ANY (should be boolean)"),
    ("instanceof operator",             "§13.10",   PARTIAL, "Returns boolean; no type narrowing"),
    ...
    ("yield expression",                "§13.5",    MISSING, "YieldExpression → T_ANY stub"),
    ("yield* delegation",               "§13.5",    MISSING, "YieldExpression delegate → T_ANY"),
  ...
  "§14 — Statements & Declarations": [
    ...
    ("Nested destructuring",            "§14.3.3",  MISSING, "ObjectPattern/ArrayPattern nested → T_ANY"),
    ("Destructuring with defaults {x=1}","§14.3.3", MISSING, "AssignmentPattern default not type-checked"),
    ("Computed destructuring {[k]:v}",  "§14.3.3",  MISSING, "Computed key in ObjectPattern → ignored"),
    ("Rest in array destructure [...r]","§14.3.3",  MISSING, "RestElement in ArrayPattern → T_ANY"),
    ("Rest in object destructure {...r}","§14.3.3",  MISSING, "RestElement in ObjectPattern → T_ANY"),
    ...
    ("Labeled statement label:",        "§14.11",   MISSING, "LabeledStatement; no label scope tracking"),
    ("break label / continue label",    "§14.8/9",  MISSING, "Label target not validated"),
    ("with statement (legacy)",         "§14.11",   MISSING, "WithStatement not handled (low priority)"),
  ...
  "§15 — Functions & Classes": [
    ...
    ("Default parameters fn(x=5)",      "§15.2",    PARTIAL, "AssignmentPattern param; default not type-checked"),
    ...
    ("Destructured parameters {a,b}",   "§15.2",    MISSING, "ObjectPattern/ArrayPattern params → T_ANY"),
    ("Optional parameters fn(x?)",      "TS",       DONE,    "param.optional flag tracked"),
    ("Async function",                  "§15.8",    DONE,    "async: wraps return in Promise<T>"),
    ("Generator function*",             "§15.5",    MISSING, "No Generator<Y,R,N> type; yield → T_ANY"),
    ("Async generator function*",       "§15.8",    MISSING, "No AsyncGenerator<Y,R,N> type"),
    ...
    ("Class expression",                "§15.7",    PARTIAL, "ClassExpression anonymous → __anonymous__"),
    ("Constructor method",              "§15.7",    DONE,    "constructor() tracked"),
    ("Instance methods",                "§15.7",    DONE,    "ClassMethod; return type checked"),
    ("Static methods",                  "§15.7",    MISSING, "ClassMethod static → not typed on type"),
    ("Instance properties",             "§15.7",    PARTIAL, "ClassProperty non-static; brand T_ANY"),
    ("Static fields",                   "§15.7",    MISSING, "ClassProperty static → T_ANY"),
    ("Private fields #field",           "§15.7",    MISSING, "PrivateName not tracked"),
    ("Private methods #method()",       "§15.7",    MISSING, "PrivateName method not typed"),
    ("Getters get x()",                 "§15.7",    MISSING, "ClassAccessorProperty / ObjectMethod get"),
    ("Setters set x(v)",                "§15.7",    MISSING, "ClassAccessorProperty / ObjectMethod set"),
    ("extends clause",                  "§15.7",    PARTIAL, "Superclass not resolved for member lookup"),
    ("super() constructor call",        "§15.7",    MISSING, "Super call → T_ANY"),
    ("super.method()",                  "§15.7",    MISSING, "Super member → T_ANY"),
    ...
    ("abstract class (TS)",             "TS",       MISSING, "Abstract not validated"),
  ...
  "§16 — Scripts & Modules": [
    ...
    ("import * as ns from 'mod'",           "§16.2",  MISSING, "ImportNamespaceSpecifier → T_ANY"),
    ...
    ("export * from 'mod'",                 "§16.2",  MISSING, "ExportAllDeclaration not tracked"),
  ...
  "§19 — Global Object": [
    ...
    ("eval() (forbidden in SJS)", "§19.2", MISSING, "eval not analyzed; runtime risk"),
    ...
    ("decodeURI / encodeURI","§19.2", MISSING, "→ T_ANY"),
    ("decodeURIComponent / encodeURIComponent","§19.2",MISSING,"→ T_ANY"),
    ("structuredClone()",   "§19.2",  MISSING, "→ T_ANY"),
    ("queueMicrotask()",    "§19.2",  MISSING, "→ T_ANY"),
  ],
  ...
  "§20 — Fundamental Objects": [
    ...
    ("Object.assign(target,...src)","§20.1",  PARTIAL, "→ T_ANY; no type merge"),
    ("Object.fromEntries()",        "§20.1",  DONE,    "→ object"),
    ("Object.freeze()",             "§20.1",  PARTIAL, "→ T_ANY; should return Readonly<T>"),
    ...
    ("Object.setPrototypeOf()",     "§20.1",  MISSING, "→ T_ANY"),
    ("Object.getOwnPropertyDescriptor()", "§20.1", MISSING, "→ T_ANY"),
    ("Object.prototype.toString()", "§20.1",  MISSING, "→ not dispatched on plain objects"),
    ("Object.prototype.hasOwnProperty()", "§20.1", MISSING, "→ no stdlib entry"),
    # Function
    ("Function()",                  "§20.2",  MISSING, "Dynamic function constructor → T_ANY"),
    ("Function.prototype.call/apply/bind","§20.2",MISSING,"→ T_ANY"),
    # Boolean
    ...
    ("new EvalError()",             "§20.5",  MISSING, "→ T_ANY"),
    ("new URIError()",              "§20.5",  MISSING, "→ T_ANY"),
    ("AggregateError ES2021",       "§20.5",  MISSING, "→ T_ANY"),
    ("SuppressedError ES2024",      "§20.5",  MISSING, "→ T_ANY"),
  ...
  "§21 — Numbers & Dates": [
    ...
    ("n.toFixed()",             "§21.1",  MISSING, "Number instance method → T_ANY"),
    ("n.toPrecision()",         "§21.1",  MISSING, "Number instance method → T_ANY"),
    ("n.toString(radix)",       "§21.1",  MISSING, "Number instance method → T_ANY"),
    # BigInt
    ("BigInt(n)",               "§21.2",  DONE,    "BigInt() → bigint"),
    ("BigInt.asIntN()",         "§21.2",  MISSING, "→ T_ANY"),
    ("BigInt.asUintN()",        "§21.2",  MISSING, "→ T_ANY"),
    ("bigint.toString()",       "§21.2",  MISSING, "BigInt instance → T_ANY"),
    # Math
  ...
  "§22 — Text Processing": [
    ...
    ("String.fromCharCode()",       "§22.1",  MISSING, "→ T_ANY"),
    ("String.fromCodePoint()",      "§22.1",  MISSING, "→ T_ANY"),
    ("String.raw``",                "§22.1",  MISSING, "Tagged template → T_ANY"),
    ...
    ("s.toWellFormed() ES2024",     "§22.1",  MISSING, "→ T_ANY"),
    ("s.isWellFormed() ES2024",     "§22.1",  MISSING, "→ T_ANY"),
    # RegExp
    ...
    ("re.exec(string)",             "§22.2",  PARTIAL, "→ T_ANY (should be RegExpExecArray|null)"),
  ...
  "§23 — Indexed Collections": [
    ...
    ("Array.from()",                "§23.1",  PARTIAL, "→ any[]; no callback inference"),
    ("Array.of()",                  "§23.1",  PARTIAL, "→ any[]; no element inference"),
    ("Array.fromAsync() ES2024",    "§23.1",  PARTIAL, "→ Promise<any[]>"),
    ...
    ("arr.reduceRight(fn, init)",   "§23.1",  MISSING, "→ T_ANY stub"),
    ("arr.find/findLast(fn)",       "§23.1",  DONE,    "→ T | undefined"),
    ("arr.findIndex/findLastIndex()","§23.1", DONE,    "→ number"),
    ("arr.flat(depth)",             "§23.1",  PARTIAL, "→ any[]; depth not tracked"),
    ...
    ("arr.keys/values/entries()",   "§23.1",  PARTIAL, "→ T_ANY; should be IterableIterator"),
    ...
    # TypedArrays
    ("Int8Array/Uint8Array etc.",   "§23.2",  MISSING, "TypedArray constructors → T_ANY"),
    ("Float32Array/Float64Array",   "§23.2",  MISSING, "→ T_ANY"),
    ("BigInt64Array/BigUint64Array","§23.2",  MISSING, "→ T_ANY"),
    ("TypedArray methods",          "§23.2",  MISSING, "set/subarray/slice/fill etc. → T_ANY"),
  ],
  ...
  "§24 — Keyed Collections": [
    ...
    ("map.keys/values/entries()","§24.1", PARTIAL, "→ T_ANY; should be IterableIterator"),
    ...
    ("set.values/keys/entries()","§24.2", PARTIAL, "→ T_ANY; should be IterableIterator"),
  ...
  "§25 — Structured Data": [
    ("ArrayBuffer",             "§25.1",  MISSING, "→ T_ANY"),
    ("SharedArrayBuffer",       "§25.1",  PARTIAL, "new SharedArrayBuffer() → T_ANY (no error)"),
    ("DataView",                "§25.3",  MISSING, "→ T_ANY"),
    ("Atomics.add/load etc.",   "§25.4",  PARTIAL, "→ T_ANY (callable)"),
    ("JSON.parse()",            "§25.5",  DONE,    "→ any"),
    ("JSON.stringify()",        "§25.5",  DONE,    "→ string"),
    ("JSON.rawJSON() ES2024",   "§25.5",  MISSING, "→ T_ANY"),
    ("JSON.isRawJSON() ES2024", "§25.5",  MISSING, "→ T_ANY"),
  ],
  ...
  "§26 — Managing Memory": [
    ...
    ("registry.unregister(token)",      "§26.2",  MISSING, "→ T_ANY"),
  ],
  ...
  "§27 — Control Abstraction": [
    ...
    ("Iterator helpers ES2025",          "§27.1",  PARTIAL, "Iterator.from() → T_ANY; helpers called"),
    ("Iterator.from()",                  "§27.1",  PARTIAL, "→ T_ANY"),
    ("iter.map/filter/take/drop",        "§27.1",  PARTIAL, "callable; return T_ANY"),
    ("iter.toArray()",                   "§27.1",  PARTIAL, "→ any[]"),
    ("iter.flatMap/reduce/some/every/find","§27.1",MISSING,"not in stdlib"),
    # Promise
    ...
    # Generator
    ("function* generator",             "§27.3",  MISSING, "No Generator<Y,R,N> type tracking"),
    ("yield expression",                "§27.3",  MISSING, "→ T_ANY stub"),
    ("yield* iterable",                 "§27.3",  MISSING, "→ T_ANY stub"),
    ("generator.next()",                "§27.3",  MISSING, "→ T_ANY"),
    ("generator.return()",              "§27.3",  MISSING, "→ T_ANY"),
    ("generator.throw()",               "§27.3",  MISSING, "→ T_ANY"),
    # Async
    ...
    ("async function*",                 "§27.7",  MISSING, "No AsyncGenerator<Y,R,N> type"),
    ("for await...of",                  "§27.7",  PARTIAL, "No AsyncIterable protocol check"),
  ],

  "§28 — Reflection": [
    ("new Proxy(target, handler)",      "§28.1",  MISSING, "→ T_ANY"),
    ("Proxy traps (get/set/has etc.)",  "§28.1",  MISSING, "Trap signatures not typed"),
    ("Proxy.revocable()",               "§28.1",  MISSING, "→ T_ANY"),
    ("Reflect.apply()",                 "§28.2",  MISSING, "No Reflect stdlib entries"),
    ("Reflect.construct()",             "§28.2",  MISSING, "→ T_ANY"),
    ("Reflect.defineProperty()",        "§28.2",  MISSING, "→ T_ANY"),
    ("Reflect.deleteProperty()",        "§28.2",  MISSING, "→ T_ANY"),
    ("Reflect.get()",                   "§28.2",  MISSING, "→ T_ANY"),
    ("Reflect.getOwnPropertyDescriptor()","§28.2",MISSING, "→ T_ANY"),
    ("Reflect.getPrototypeOf()",        "§28.2",  MISSING, "→ T_ANY"),
    ("Reflect.has()",                   "§28.2",  MISSING, "→ T_ANY"),
    ("Reflect.isExtensible()",          "§28.2",  MISSING, "→ T_ANY"),
    ("Reflect.ownKeys()",               "§28.2",  MISSING, "→ T_ANY"),
    ("Reflect.set()",                   "§28.2",  MISSING, "→ T_ANY"),
    ("Reflect.setPrototypeOf()",        "§28.2",  MISSING, "→ T_ANY"),
  ],
  ...
  "§TS — TypeScript / SJS Type System": [
    ...
    ("Generic functions fn<T>(x:T):T",  "TS",     MISSING, "Type args not bound at call site"),
    ("Conditional types T extends U?X:Y","TS",    MISSING, "→ T_ANY"),
    ("Mapped types {[K in T]: V}",      "TS",     PARTIAL, "→ object stub"),
    ("Template literal types `${T}`",   "TS",     MISSING, "→ T_ANY"),
    ("Index access types T[K]",         "TS",     MISSING, "→ T_ANY"),
    ("infer keyword",                   "TS",     MISSING, "→ T_ANY"),
    ("Tuple types [string, number]",    "TS",     DONE,    "TupleType; index access; destructuring"),
    ("Optional tuple elements [T?]",    "TS",     MISSING, "→ T_ANY"),
    ("Rest in tuple [...T[]]",          "TS",     PARTIAL, "TSRestType parsed; not fully checked"),
    ("Labeled tuple [a:T, b:U]",        "TS",     PARTIAL, "Labels ignored; types used"),
    ("Record<K,V>",                     "TS",     PARTIAL, "→ object stub; no key/value tracking"),
    ("Partial<T> / Required<T>",        "TS",     PARTIAL, "→ T_ANY"),
    ("Readonly<T>",                     "TS",     PARTIAL, "→ T_ANY (but readonly keyword tracked)"),
    ("Pick<T,K> / Omit<T,K>",          "TS",     MISSING, "→ T_ANY"),
    ("Exclude<T,U> / Extract<T,U>",    "TS",     MISSING, "→ T_ANY"),
    ("NonNullable<T>",                  "TS",     MISSING, "→ T_ANY"),
    ("ReturnType<F> / Parameters<F>",   "TS",     MISSING, "→ T_ANY"),
    ...
    ("Type narrowing (instanceof)",     "TS",     PARTIAL, "boolean result; no branch narrowing"),
    ("Type narrowing (null check)",     "TS",     DONE,    "x !== null / !x narrowing"),
    ("Type narrowing (truthy)",         "TS",     DONE,    "if (x) removes null/undefined"),
    ("User-defined type guards",        "TS",     PARTIAL, "x is T annotation; no inference"),
    ("const assertions as const",       "TS",     MISSING, "→ T_ANY"),
    ("satisfies operator",              "TS4.9",  DONE,    "TSSatisfiesExpression"),
    ("using / await using (TC39)",      "TC39",   MISSING, "Disposable resources not tracked"),
