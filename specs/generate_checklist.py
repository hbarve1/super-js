...
SECTIONS = {
  ...
  "§13 — Expressions": [
    ...
    ("yield expression",                "§13.5",    PARTIAL, "YieldExpression → T_ANY; no Generator<Y> tracking yet"),
    ("yield* delegation",               "§13.5",    PARTIAL, "YieldExpression delegate → T_ANY"),
  ...
  "§27 — Control Abstraction": [
    ...
    ("yield expression",                "§27.3",  PARTIAL, "→ T_ANY; nextType not tracked"),
    ("yield* iterable",                 "§27.3",  PARTIAL, "→ T_ANY; delegation type not inferred"),
