...
SECTIONS = {
  ...
  "§15 — Functions & Classes": [
    ...
    ("Destructured parameters {a,b}",   "§15.2",    PARTIAL, "ObjectPattern/ArrayPattern params → bindings registered as T_ANY in body"),
  ...
  "§20 — Fundamental Objects": [
    ...
    ("Object.assign(target,...src)","§20.1",  PARTIAL, "→ target type; sources not merged into result"),
