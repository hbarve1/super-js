...
This page tracks all releases and updates for Super.js 0.1.0 and earlier versions.

## Recent Releases

- **[0.1.0](/docs/0.1.0/changelog/0.1.0)** - Initial stable release (2024-01-01)
- **[0.0.1](/docs/0.1.0/changelog/0.0.1)** - Initial alpha release (2023-12-15)
