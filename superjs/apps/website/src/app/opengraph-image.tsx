...
/** Static OG card (SPEC §E-1): wordmark + chips on the left, code panel on the right. */
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', flex: '0 0 380px' }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '2px' }}>
            <span style={{ fontSize: '72px', fontWeight: 900, color: '#f8fafc', letterSpacing: '-2px' }}>Super</span>
            <span style={{ fontSize: '72px', fontWeight: 900, color: '#f97316' }}>.</span>
            <span style={{ fontSize: '72px', fontWeight: 900, color: '#f8fafc', letterSpacing: '-2px' }}>js</span>
          </div>
