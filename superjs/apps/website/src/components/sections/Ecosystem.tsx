...
export function Ecosystem() {
  return (
    <section className="py-20 overflow-hidden border-y border-hairline-soft">
      <div className="text-center mb-10">
        <p className="text-orange-400 text-sm uppercase tracking-widest mb-2">Ecosystem</p>
        <h2 className="text-3xl font-bold text-text-primary">Works everywhere JavaScript does</h2>
      </div>
