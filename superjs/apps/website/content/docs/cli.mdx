...
`superjs doc` (sound, type-aware documentation generation — [ADR-009](https://github.com/hbarve1/super-js/blob/main/specs/design/ADR-009-doc-gen.md)),
`lint`, `format`, and `test` are reserved for later stages; invoking one today
prints a not-yet-implemented notice and exits non-zero.
