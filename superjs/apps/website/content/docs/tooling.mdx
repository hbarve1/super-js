...
> **Planned (Stage 3+):** `superjs lint`, `superjs format`, and `superjs test`
> are reserved and currently print a not-yet-implemented notice. Linting and
> formatting are tracked on the [roadmap](https://github.com/hbarve1/super-js/tree/main/specs/roadmap).
