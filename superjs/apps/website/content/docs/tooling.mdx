...
are always processed. See the [formatter integration guide](https://github.com/hbarve1/super-js/blob/main/specs/design/formatter-integration.md)
...
no-unused-import (L009), import-order (L010), no-unused-var (L012), no-explicit-dynamic (L013), no-shadowing (L014), no-floating-promise (L015), and no-unhandled-result (L016).
