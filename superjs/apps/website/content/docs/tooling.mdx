...
> **Planned (Stage 3+):** `superjs doc` (sound, type-aware code-documentation
> generation — see [ADR-009](https://github.com/hbarve1/super-js/blob/main/specs/design/ADR-009-doc-gen.md)),
> `superjs lint`, `superjs format`, and `superjs test` are reserved and currently
> print a not-yet-implemented notice. They're tracked on the
> [roadmap](https://github.com/hbarve1/super-js/tree/main/specs/roadmap).
