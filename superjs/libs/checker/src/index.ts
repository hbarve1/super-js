...
import { Checker, type CheckOptions, type TypedSpan, type ModuleSurface } from './lib/checker.js';

export { Checker } from './lib/checker.js';
export type { CheckOptions, TypedSpan, ModuleSurface } from './lib/checker.js';
...
export interface CheckResult {
  ...
  /** This module's exported type + value surface, for cross-file imports. */
...
export function check(source: string, opts: CheckOptions = {}): CheckResult {
  ...
  return { diagnostics: [...diagnostics, ...checked.diagnostics], types: checked.types, surface: checked.surface };
}
